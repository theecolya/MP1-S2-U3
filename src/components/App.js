...
import { applyNumber, changeOperation, clearCalc, addToMem, combineMem, memClear } from '../actions';
import './App.css';
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton value={"MR"} onClick={handleMemCombine}/>
